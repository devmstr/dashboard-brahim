...
interface RequisitionArticleDialogProps {
  open: boolean
...
export function RequisitionArticleDialog({
  open,
  onOpenChange,
  initialData,
  onSave,
  itemsOptions
}: RequisitionArticleDialogProps) {
  ...
  const updateDraft = React.useCallback(
    <K extends keyof ArticleItem>(field: K, value: ArticleItem[K]) => {
      setDraftItem((prev) => {
        ...
        // Auto-fill logic when picking an item from combobox
