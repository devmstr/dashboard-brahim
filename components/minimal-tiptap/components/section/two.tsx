...
const formatActions: TextStyle[] = [
  ...
  //   value: 'underline',
  //   label: 'Underline',
  //   icon: <UnderlineIcon className="size-5" />, // Add underline icon
  //   action: (editor) => editor.chain().focus().toggleUnderline().run(), // Toggle underline
  //   isActive: (editor) => editor.isActive('underline'),
  //   canExecute: (editor) =>
  //     editor.can().chain().focus().toggleUnderline().run() &&
  //     !editor.isActive('codeBlock'),
  //   shortcuts: ['mod', 'U'] // Common shortcut for underline
  // },
  {
    value: 'strikethrough',
    label: 'Strikethrough',
