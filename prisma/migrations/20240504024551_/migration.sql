...
-- AddForeignKey
ALTER TABLE `Order` ADD CONSTRAINT `Order_technicalId_fkey` FOREIGN KEY (`technicalId`) REFERENCES `Technical`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
